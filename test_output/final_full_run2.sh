...
for attempt in $(seq 1 40); do
  ...
  if [ -z "$(echo $REMAINING | tr -d ' ')" ]; then echo "ALL 101 DONE after attempt $attempt" >> /Users/Zhuanz1/PycharmProjects/同花顺/test_output/final_run_progress.log; break; fi
...
" >> /Users/Zhuanz1/PycharmProjects/同花顺/test_output/final_run_progress.log
  echo "cooling 300s" >> /Users/Zhuanz1/PycharmProjects/同花顺/test_output/final_run_progress.log
  sleep 300
done
