...
const EVENT_TYPE_BADGES: Record<string, { label: string; icon: string; cls: string }> = {
  ...
  tool_call: { label: '调度', icon: '🛠️', cls: 'badge-warning' },
  ...
  info: { label: '动态', icon: 'ℹ️', cls: 'badge-info' },
  warn: { label: '预警', icon: '⚠️', cls: 'badge-danger' },
  warning: { label: '预警', icon: '⚠️', cls: 'badge-danger' },
      ...
      <div ref="streamBoxRef" class="feed-box">
        ...
        >
          ...
          <span class="line-badge" :class="getEventBadge(evt.event_type).cls">
            {{ getEventBadge(evt.event_type).icon }} {{ getEventBadge(evt.event_type).label }}
          </span>
