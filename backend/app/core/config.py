...
class Settings(BaseModel):
    ...
    def apply_to_env(self) -> None:
        ...
        os.environ["IMAGE_API_KEY"] = os.getenv("IMAGE_API_KEY", "")
        os.environ["IMAGE_BASE_URL"] = os.getenv("IMAGE_BASE_URL", "https://ark.cn-beijing.volces.com/api/v3")
        os.environ["IMAGE_MODEL"] = os.getenv("IMAGE_MODEL", "doubao-seedream-3-0-t2i-250415")
