...
class ReportViewModel(BaseModel):
    model_config=ConfigDict(extra="forbid")
    report_id:str;title:str;subject:str;as_of:date;generated_at:datetime=Field(default_factory=lambda:datetime.now(timezone.utc));tone:str;report_depth:str;visual_style:str;delivery_status:Literal["ready","ready_with_limits"]
