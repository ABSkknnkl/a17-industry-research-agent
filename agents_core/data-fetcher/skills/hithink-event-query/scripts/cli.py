...
SKILL_NAME = "hithink-event-query"
SKILL_VERSION = "1.0.0"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财事件数据 - 事件数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "同花顺业绩预告"
  python3 scripts/cli.py --query "最近的增发配股"
  python3 scripts/cli.py --query "机构调研记录" --page "2" --limit "20"
  python3 scripts/cli.py --query "监管函" --api-key "your-key"
